 ...
 */
public class ConfigurationPanelCustom
                ...
                ServiceListener
{
    ...
    private static final Logger logger
        = Logger.getLogger(ConfigurationPanelCustom.class);

    private static final int BORDER_SIZE = 20;

    private final ConfigFormListPanelCustom configList;
     ...
     */
    public ConfigurationPanelCustom()
    {
...
//            MacUtils.makeWindowLeopardStyle(this);
