 ...
 */
public class ConfigFormListPanelCustom
    extends JList
    implements ListSelectionListener
{
    private final DefaultListModel listModel = new DefaultListModel();

    private final ConfigurationPanelCustom configFrame;

    /**
     * Creates an instance of <tt>ConfigFormList</tt>
     * @param configFrame the parent configuration frame
     */
    public ConfigFormListPanelCustom(ConfigurationPanelCustom configFrame)
    {
